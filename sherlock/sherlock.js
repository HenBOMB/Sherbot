...
class SitesHandler
{
    ...
    static removeBlocked(siteData)
    {
        ...
        const blocked = [
            "3dnews", "VK", "Velomania", "Football", "BOOTH", "prog.hu", "Packagist", "Xvideos", "xHamster",
            "opennet", "iMGSRC.RU", "Naver",
            "Bookcrossing", //banned? timed out?
            "authorSTREAM", // too slow
        ...
        return await new Promise(resolve => {
            ...
            for(const key in this.sites)
            {
                ...
                (() => {
                    ...
                    {
                        // console.log(key + " - " + (now.getSeconds() - (new Date()).getSeconds()))
